...
/**
 * \defgroup drivers_USBCombi USBCombi class
 * \ingroup drivers-public-api-usb
 * @{
 */

class USBCombi: public USBDevice {
public:
    ...
    */
    USBCombi(bool connect_blocking = true, uint16_t vendor_id = 0xffff, uint16_t product_id = 0x0005, uint16_t product_release = 0x0001);
    ...
    * @param product_release Your product_release
    */
    USBCombi(USBPhy *phy, uint16_t vendor_id, uint16_t product_id, uint16_t product_release);
